...
[wxID_FRAME1, wxID_FRAME1B1, wxID_FRAME1B2, wxID_FRAME1B3, wxID_FRAME1PANEL1, 
...
class Frame1(wx.Frame):
    def _init_ctrls(self, prnt):
        ...
        self.b2 = wx.Button(id=wxID_FRAME1B2, label=u'\u8bad\u7ec3', name=u'b2',
              parent=self.panel1, pos=wx.Point(136, 54), size=wx.Size(75, 24),
              style=0)
        ...
        self.b3 = wx.Button(id=wxID_FRAME1B3, label=u'\u5339\u914d', name=u'b3',
              parent=self.panel1, pos=wx.Point(236, 54), size=wx.Size(75, 24),
              style=0)
